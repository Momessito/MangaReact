...
function Categories() {
  ...
  return (<ScrollContainer className="scroll-container scrollH">
    ...
    {items.length === 0 ?         <div className='categories2'>Nenhum Manga Adicionado... <img src="https://64.media.tumblr.com/5e3b8ef08a53e3c054717129e345db59/d68a5dee2d650b34-9c/s400x600/875f3686901573006d0c0e984a0430634680498d.jpg" /> </div> : (
      items.map((post) => (
