...
<div className='allchapters'>
            ...
            <div className="Filter">
                ...
                <div className='filterI'><svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-search" viewBox="0 0 16 16">
                    ...
                    posts.map((post) => (
                        <Link to={'/chapter/' + post.release_id} key={post.release_id}>
                            <div className='ChaptersCard' id='ChaptersCard'>
                                <h2>{post.name}</h2>
                                <h4 id='capit'>{post.number} {post.chapter_name}</h4>
